...
export default function AdminLayout() {
  ...
  const navigation = [
    ...
    { name: 'Subscriptions', href: '/admin/subscriptions', icon: CurrencyDollarIcon, current: location.pathname === '/admin/subscriptions' },
    { name: 'System Settings', href: '/admin/settings', icon: ServerIcon, current: location.pathname === '/admin/settings' },
  ];
